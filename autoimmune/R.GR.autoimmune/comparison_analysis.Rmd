...
colnames(mtx.cor.epi.joined) <- c("Farh", "jaccard", "msh.path", "snomed.path", "snomed.vector", "iridescent.minMim", "iridescent.misn", "iridescent.obsExp", "iridescent.relOverlap", "iridescent.sharedRels", "dose.jiang", "dose.lin", "dose.rel", "dose.resnik", "dose.wang", "Encode.Tfbs", "Roadmap.broadPeak", "Roadmap.Dnase.hotspotbroadall", "Roadmap.Dnase.narrowPeak", "Roadmap.gappedPeak", "Roadmap.narrowPeak", "Roadmap.chromStates18", "Roadmap.combined")
