...
if (mat.type == "PVAL") {
  dname <- list("data.gr/2ENCODE_Tfbs/matrix_PVAL.txt",
              "data.gr/2ENCODE_Dnase/matrix_PVAL.txt",
              "data.gr/2ENCODE_Histone/matrix_PVAL.txt",
              c("data.gr/2ENCODE_Tfbs/matrix_PVAL.txt", "data.gr/2ENCODE_Dnase/matrix_PVAL.txt", "data.gr/2ENCODE_Histone/matrix_PVAL.txt"),
             "data.gr/2Roadmap_broadPeak/matrix_PVAL.txt",
             "data.gr/2Roadmap_DNase_hotspotbroadall/matrix_PVAL.txt",
             "data.gr/2Roadmap_DNase_narrowPeak/matrix_PVAL.txt",
             "data.gr/2Roadmap_gappedPeak/matrix_PVAL.txt",
             "data.gr/2Roadmap_narrowPeak/matrix_PVAL.txt",
             "data.gr/2Roadmap_chromStates18/matrix_PVAL.txt",
             c("data.gr/2Roadmap_broadPeak/matrix_PVAL.txt", "data.gr/2Roadmap_DNase_hotspotbroadall/matrix_PVAL.txt", "data.gr/2Roadmap_DNase_narrowPeak/matrix_PVAL.txt", "data.gr/2Roadmap_gappedPeak/matrix_PVAL.txt", "data.gr/2Roadmap_narrowPeak/matrix_PVAL.txt", "data.gr/2Roadmap_chromStates18/matrix_PVAL.txt")
           )
} else if (mat.type == OR) {
  dname <- list("data.gr/2ENCODE_Tfbs/matrix_OR.txt",
              "data.gr/2ENCODE_Dnase/matrix_OR.txt",
              "data.gr/2ENCODE_Histone/matrix_OR.txt",
              c("data.gr/2ENCODE_Tfbs/matrix_OR.txt", "data.gr/2ENCODE_Dnase/matrix_OR.txt", "data.gr/2ENCODE_Histone/matrix_OR.txt"),
             "data.gr/2Roadmap_broadPeak/matrix_OR.txt",
             "data.gr/2Roadmap_DNase_hotspotbroadall/matrix_OR.txt",
             "data.gr/2Roadmap_DNase_narrowPeak/matrix_OR.txt",
             "data.gr/2Roadmap_gappedPeak/matrix_OR.txt",
             "data.gr/2Roadmap_narrowPeak/matrix_OR.txt",
             "data.gr/2Roadmap_chromStates18/matrix_OR.txt",
             c("data.gr/2Roadmap_broadPeak/matrix_OR.txt", "data.gr/2Roadmap_DNase_hotspotbroadall/matrix_OR.txt", "data.gr/2Roadmap_DNase_narrowPeak/matrix_OR.txt", "data.gr/2Roadmap_gappedPeak/matrix_OR.txt", "data.gr/2Roadmap_narrowPeak/matrix_OR.txt", "data.gr/2Roadmap_chromStates18/matrix_OR.txt")
           )
}
...
# Set the column names after merging lists
colnames(mtx.cor.epi.joined)[ (length(mtx.list.epi) + 1):length(colnames(mtx.cor.epi.joined))] <- c("Encode.Tfbs", "Encode.Dnase", "Encode.Histone", "Encode.combined", "Roadmap.broadPeak", "Roadmap.Dnase.hotspotbroadall", "Roadmap.Dnase.narrowPeak", "Roadmap.gappedPeak", "Roadmap.narrowPeak", "Roadmap.chromStates18", "Roadmap.combined")
```
