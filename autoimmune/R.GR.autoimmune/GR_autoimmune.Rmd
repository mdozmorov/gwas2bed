...
```{r RegOverlapCorrel1}
mtx.cor.melted <- melt(mtx.cor[[1]]) # Convert correlation matrix to long format
b <- mtx.cor.melted[!(mtx.cor.melted[, 1] == mtx.cor.melted[, 2]), , drop=F] # Exclude self-self associations
