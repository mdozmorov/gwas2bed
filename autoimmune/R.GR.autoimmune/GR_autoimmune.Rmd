...
The top 10 pairs of disease- aassociated SNPs are most similar with each other. The correlation coefficient shows `r (cortype)` correlation coefficient among the regulatory enrichment profiles for each term-specific SNP set.
