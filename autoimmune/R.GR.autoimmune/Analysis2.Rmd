...
```{r eval=TRUE, fig.height=6}
ind <- term.mapping$Category == "immunological" # Indexes of immunological diseases
...
set.seed(1)
result <- parPvclust(cl=cl, mtx.scaled[, ind], method.dist="correlation", method.hclust=hclust.method, nboot=100)
stopCluster(cl)
#saveRDS(result, "data/pvClust_1000.Rds")
#result <- readRDS("data/pvClust_1000.Rds")
#dev.off()
plot(result, hang = -1)
pvrect(result, alpha=0.63)
