...
The matrix is scaled, so the enrichment profile for each disease/phenotype has mean = 0 and SD = 1. 
...
h <- aheatmap(mtx.cor, Rowv=as.dendrogram(hclustergram), Colv=as.dendrogram(hclustergram), color="-RdYlBu", annCol=annot, annColors = annotColor, fontsize = 10, cexRow = 1, cexCol = 1)
```
...
h <- aheatmap(mtx.cor.imm, Rowv=as.dendrogram(hclustergram.imm), Colv=as.dendrogram(hclustergram.imm), color="-RdYlBu")
```
