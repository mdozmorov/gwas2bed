...
```{r eval=TRUE, results='show'}
kable(gr_maxmin(mtx.scaled, cortype="spearman", "results/maxmin_corr_all.txt"))
```
...
```{r eval=TRUE}
ind <- categoryNames == "immunological" # Indexes of immunological diseases
```

Get the minimum and maximum correlations among all diseases

```{r eval=TRUE, results='show'}
kable(gr_maxmin(mtx.scaled[, ind], cortype="spearman", "results/maxmin_corr_imm.txt"))
```
...
# stopCluster(cl)
# saveRDS(result, "data/pvClust_02.Rds")
# result <- readRDS("data/pvClust_01.Rds") # ind-subset, method.dist="correlation", method.hclust=hclust.method, nboot=10000
result <- readRDS("data/pvClust_02.Rds") # ind-subset, method.dist=spm, method.hclust=hclust.method, nboot=10000
...
```{r eval=TRUE, results='show'}
mtx.degs <- gr_load_data("data.gr.05/grweb_encTFBS_cellspecific/matrix_PVAL.txt")
colnames(mtx.degs) <- gr_trimnames(colnames(mtx.degs))
res <- gr_degfs(mtx.degs[, mtx.clust$eset.labels], mtx.clust, cutoff.pval = 0.1, cutoff.adjust = "fdr", fileName = "results/degfs_encTFBS_cellspecific.xlsx")
kable(res[[1]][1:10, c(1, 2, 3, 4, 10, 11, 12, 13)])
```

### ENCODE TFBS clustered

```{r eval=TRUE, results='show'}
mtx.degs <- gr_load_data("data.gr.05/grweb_encTFBS_clustered/matrix_PVAL.txt")
colnames(mtx.degs) <- gr_trimnames(colnames(mtx.degs))
res <- gr_degfs(mtx.degs[, mtx.clust$eset.labels], mtx.clust, cutoff.pval = 0.1, cutoff.adjust = "fdr", fileName = "results/degfs_encTFBS_clustered.xlsx")
#res <- gr_degfs(mtx.degs[, mtx.clust$eset.labels], mtx.clust, cutoff.pval = 0.1, cutoff.adjust = "fdr", nperm = 1000, fileName = "results/degfs_encTFBS_clustered_perm.xlsx")
kable(res[[1]][1:10, c(1, 2, 3, 4, 10, 11, 12, 13)])
```
...
```{r eval=TRUE, results='show'}
mtx.degs <- gr_load_data("data.gr.05/grweb_roadmapChrom15/matrix_PVAL.txt", subset = cells_blood_all)
colnames(mtx.degs) <- gr_trimnames(colnames(mtx.degs))
res <- gr_degfs(mtx.degs[, mtx.clust$eset.labels], mtx.clust, cutoff.pval = 0.1, cutoff.adjust = "fdr", fileName = "results/degfs_chromStates15.xlsx")
kable(res[[1]][1:10, c(1, 2, 3, 4, 10, 11, 12, 13)])
```
...
```{r eval=TRUE, results='show'}
mtx.degs <- gr_load_data("data.gr.05/grweb_roadmapChrom18/matrix_PVAL.txt", subset = cells_blood_all)
colnames(mtx.degs) <- gr_trimnames(colnames(mtx.degs))
res <- gr_degfs(mtx.degs[, mtx.clust$eset.labels], mtx.clust, cutoff.pval = 0.1, cutoff.adjust = "fdr", fileName = "results/degfs_chromStates18.xlsx")
kable(res[[1]][1:10, c(1, 2, 3, 4, 10, 11, 12, 13)])
```
...
```{r eval=TRUE, results='show'}
mtx.degs <- gr_load_data("data.gr.05/grweb_roadmapChrom25/matrix_PVAL.txt", subset = cells_blood_all)
colnames(mtx.degs) <- gr_trimnames(colnames(mtx.degs))
res <- gr_degfs(mtx.degs[, mtx.clust$eset.labels], mtx.clust, cutoff.pval = 0.1, cutoff.adjust = "fdr", fileName = "results/degfs_chromStates25.xlsx")
kable(res[[1]][1:10, c(1, 2, 3, 4, 10, 11, 12, 13)])
```
...
```{r eval=TRUE, results='show'}
mtx.degs <- gr_load_data("data.gr.05/grweb_roadmapDNase_bPk-processed/matrix_PVAL.txt", subset = cells_blood_all)
colnames(mtx.degs) <- gr_trimnames(colnames(mtx.degs))
res <- gr_degfs(mtx.degs[, mtx.clust$eset.labels], mtx.clust, cutoff.pval = 0.1, cutoff.adjust = "fdr", fileName = "results/degfs_DNase_bPk-processed.xlsx")
kable(res[[1]][1:10, c(1, 2, 3, 4, 10, 11, 12, 13)])
```
...
```{r eval=TRUE, results='show'}
mtx.degs <- gr_load_data("data.gr.05/grweb_roadmapDNase_gPk-imputed/matrix_PVAL.txt", subset = cells_blood_all)
colnames(mtx.degs) <- gr_trimnames(colnames(mtx.degs))
res <- gr_degfs(mtx.degs[, mtx.clust$eset.labels], mtx.clust, cutoff.pval = 0.1, cutoff.adjust = "fdr", fileName = "results/degfs_DNase_gPk-imputed.xlsx")
kable(res[[1]][1:10, c(1, 2, 3, 4, 10, 11, 12, 13)])
```
...
```{r eval=TRUE, results='show'}
mtx.degs <- gr_load_data("data.gr.05/grweb_roadmapDNase_nPk-imputed/matrix_PVAL.txt", subset = cells_blood_all)
colnames(mtx.degs) <- gr_trimnames(colnames(mtx.degs))
res <- gr_degfs(mtx.degs[, mtx.clust$eset.labels], mtx.clust, cutoff.pval = 0.1, cutoff.adjust = "fdr", fileName = "results/degfs_DNase_nPk-imputed.xlsx")
kable(res[[1]][1:10, c(1, 2, 3, 4, 10, 11, 12, 13)])
```
...
```{r eval=TRUE, results='show'}
mtx.degs <- gr_load_data("data.gr.05/grweb_roadmapDNase_nPk-processed/matrix_PVAL.txt", subset = cells_blood_all)
colnames(mtx.degs) <- gr_trimnames(colnames(mtx.degs))
res <- gr_degfs(mtx.degs[, mtx.clust$eset.labels], mtx.clust, cutoff.pval = 0.1, cutoff.adjust = "fdr", fileName = "results/degfs_DNase_nPk-processed.xlsx")
kable(res[[1]][1:10, c(1, 2, 3, 4, 10, 11, 12, 13)])
```
...
```{r eval=TRUE, results='show'}
mtx.degs <- gr_load_data("data.gr.05/grweb_roadmapHistone_bPk-processed/matrix_PVAL.txt", subset = cells_blood_all)
colnames(mtx.degs) <- gr_trimnames(colnames(mtx.degs))
res <- gr_degfs(mtx.degs[, mtx.clust$eset.labels], mtx.clust, cutoff.pval = 0.1, cutoff.adjust = "fdr", fileName = "results/degfs_Histone_bPk-processed.xlsx")
kable(res[[1]][1:10, c(1, 2, 3, 4, 10, 11, 12, 13)])
```
...
```{r eval=TRUE, results='show'}
mtx.degs <- gr_load_data("data.gr.05/grweb_roadmapHistone_gPk-imputed/matrix_PVAL.txt", subset = cells_blood_all)
colnames(mtx.degs) <- gr_trimnames(colnames(mtx.degs))
res <- gr_degfs(mtx.degs[, mtx.clust$eset.labels], mtx.clust, cutoff.pval = 0.1, cutoff.adjust = "fdr", fileName = "results/degfs_Histone_gPk-imputed.xlsx")
kable(res[[1]][1:10, c(1, 2, 3, 4, 10, 11, 12, 13)])
```
...
```{r eval=TRUE, results='show'}
mtx.degs <- gr_load_data("data.gr.05/grweb_roadmapHistone_gPk-processed/matrix_PVAL.txt", subset = cells_blood_all)
colnames(mtx.degs) <- gr_trimnames(colnames(mtx.degs))
res <- gr_degfs(mtx.degs[, mtx.clust$eset.labels], mtx.clust, cutoff.pval = 0.1, cutoff.adjust = "fdr", fileName = "results/degfs_Histone_gPk-processed.xlsx")
kable(res[[1]][1:10, c(1, 2, 3, 4, 10, 11, 12, 13)])
```
...
```{r eval=TRUE, results='show'}
mtx.degs <- gr_load_data("data.gr.05/grweb_roadmapHistone_nPk-imputed/matrix_PVAL.txt", subset = cells_blood_all)
colnames(mtx.degs) <- gr_trimnames(colnames(mtx.degs))
res <- gr_degfs(mtx.degs[, mtx.clust$eset.labels], mtx.clust, cutoff.pval = 0.1, cutoff.adjust = "fdr", fileName = "results/degfs_Histone_nPk-imputed.xlsx")
kable(res[[1]][1:10, c(1, 2, 3, 4, 10, 11, 12, 13)])
```
...
```{r eval=TRUE, results='show'}
mtx.degs <- gr_load_data("data.gr.05/grweb_roadmapHistone_nPk-processed/matrix_PVAL.txt", subset = cells_blood_all)
colnames(mtx.degs) <- gr_trimnames(colnames(mtx.degs))
res <- gr_degfs(mtx.degs[, mtx.clust$eset.labels], mtx.clust, cutoff.pval = 0.1, cutoff.adjust = "fdr", fileName = "results/degfs_Histone_nPk-processed.xlsx")
kable(res[[1]][1:10, c(1, 2, 3, 4, 10, 11, 12, 13)])
```
...
fname <- c("data.gr.05/grweb_roadmapDNase_bPk-processed//matrix_PVAL.txt", "data.gr.05/grweb_roadmapDNase_nPk-processed//matrix_PVAL.txt", "data.gr.05/grweb_roadmapHistone_bPk-processed//matrix_PVAL.txt", "data.gr.05/grweb_roadmapHistone_gPk-processed//matrix_PVAL.txt", "data.gr.05/grweb_roadmapHistone_nPk-processed//matrix_PVAL.txt") # Processed-ALL
mtx <- gr_load_data(fname)
res <- gr_cellspecific(mtx, fileName="test.xlsx")
```
