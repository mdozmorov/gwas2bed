...
mtx <- as.matrix(load_gr_data(c("data.gr/Roadmap_broadPeak2/matrix_PVAL.txt")))# , "data.gr/Roadmap_DNase_hotspotbroadall/matrix_PVAL.txt")))
...
par(mfrow=c(1, 2))
hcut <- 40 # Empirically set height to cut the tree
