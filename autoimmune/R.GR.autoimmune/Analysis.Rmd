...
mtx.cor <- rcorr(load_gr_data(c("data.gr/Roadmap_broadPeak/matrix_PVAL.txt", "data.gr/ENCODE_Tfbs/matrix_PVAL.txt")), type=cortype)[[1]]
#mtx.cor <- rcorr(load_gr_data(c("data.gr/ENCODE_Tfbs/matrix_PVAL.txt")), type=cortype)[[1]]
...
mtx.heat <- mtx.plot(mtx.cor, SideColors=ColSideColors, dist.method="euclidean") # Clustering parameters
```
...
result <- parPvclust(cl=cl, as.matrix(mtx.cor), method.dist=dist.method, method.hclust=hclust.method, nboot=10000, weight=TRUE)
